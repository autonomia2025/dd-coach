...
export const Testimonials = () => {
  return (
    <section className="py-32 px-6 md:px-10 border-t border-border-strong overflow-hidden">
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="mb-20">
          ...
          <h2 className="font-display text-[clamp(48px,7vw,120px)] leading-[0.9] uppercase mt-4">
            Lo que dicen <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {TESTIMONIALS.map((t, i) => (
            <motion.div
              ...
              className={cn(
                "bg-bg-card border border-border/50 p-10 relative group",
                t.cols
              )}
            >
              {/* Giant Quote Icon */}
